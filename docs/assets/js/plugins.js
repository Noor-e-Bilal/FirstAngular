  ...
  (function (jQuery, ytp) {
    ...
    jQuery.mbYTPlayer = {
      ...
      buildPlayer: function (options) {
        return this.each(function () {
          ...
          if (
            ...
            property.vol =
              property.vol == 0 ? (property.vol = 1) : property.vol;
          jQuery.extend(
            YTPlayer.opt,
      ...
      changeMovie: function (opt) {
        ...
        setTimeout(function () {
          var quality = !jQuery.browser.chrome
            ? YTPlayer.opt.quality
            : "default";
          jQuery(YTPlayer)
            .getPlayer()
        ...
        this.updateScrollBar = function (d) {
          if (b.ishwscroll)
            ...
            var f =
              ...
              e = b.opt.railoffset;
            e &&
              (e.top && (g += e.top), b.rail.align && e.left && (f += e.left));
            b.locked ||
              b.rail.css({
                top: g,
                left: f,
                    ...
                    if (b.railh && b.railh.scrollable) {
                      ...
                      b.ishwscroll && b.opt.bouncescroll
                        ? 0 > m
                          ...
                          : m > b.page.maxw &&
                            (m =
                              b.page.maxw + Math.round((m - b.page.maxw) / 2))
                        : (0 > m && (l = m = 0),
              ...
              !f.cantouch && !b.opt.touchbehavior
                ...
                : (b.bind(
                  ...
                  b.opt.cursordragontouch &&
                    ...
                    b.cursorh &&
                      b.bind(b.cursorh, "mousemove", b.onmousemove)));
          ...
          ? b.ishwscroll && f.hastransition && b.opt.usetransition
            ...
            : ((this.doScrollLeft = function (c, f) {
              ...
              (this.doScrollPos = function (c, f, g) {
                ...
                f =
                  "undefined" == typeof f || !1 === f ? b.getScrollTop(!0) : f;
      ...
      H = function (e) {
        ...
        this.doMomentum = function (e) {
          ...
          if ((c.speedy && k && c.speedy) || e) {
            ...
            50 < f &&
              ((e = f / 50), (c.speedx *= e), (c.speedy *= e), (f = 50));
            c.demulxy = 0;
    ...
    t.extend(n.prototype, {
      ...
      glitch: function () {
        ...
        if (this.settings.destroy === !0)
          ...
          var d = t(r).clone();
          if (
            (d.insertBefore(r).addClass("back").css({
              "z-index": f,
            }),
